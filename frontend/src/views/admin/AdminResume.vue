  ...
  <div class="w-full">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-base font-semibold text-gray-900">Resumes</h1>
        <p class="mt-2 text-sm text-gray-700">A list of all the resumes you have created for different applications</p>
      </div>
